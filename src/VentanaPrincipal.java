...
public class VentanaPrincipal {
	...
	JLabel SABIPASIL, ACROL, ARCAL, ATLEL, ENGAL, HISTL, INTEL, INTIL, INVEL, MANOL, ANIML, MEDIL, NATUL, PERCL, INTENL, PERSL, RELIL, SIGIL, SOBREL;
	JTextField SABIPASI, ACRO, ARCA, ATLE, ENGA, HIST, INTE, INTI, INVE, MANO, ANIM, MEDI, NATU, PERC, INTEN, PERS, RELI, SIGI, SOBRE;
	...
	public void inicializarComponentes() {
		...
		clases.addItem(" - Elija - ");
		clases.addItem("Bárbaro");
		clases.addItem("Luchador");
		clases.addItem("Monje");
		clases.addItem("Paladín");
		clases.addItem("Bardo");
		clases.addItem("Ranger");
		clases.addItem("Pícaro");
		clases.addItem("Clérigo");
		clases.addItem("Druida");
		clases.addItem("Hechicero");
		clases.addItem("Brujo");
		clases.addItem("Mago");
		...
		alineamiento.addItem(" - Elija - ");
		alineamiento.addItem("1");
		alineamiento.addItem("2");
		alineamiento.addItem("3");
